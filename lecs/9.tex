...
So what do we do? We use the fact that SVMs don't just give binary answer, but also have express sort of confidence in it. That is, we pick $\underset{i}{\operatorname{argmax}}\ w_i^T x - b_i$
